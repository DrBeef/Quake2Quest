...
=================
*/
void SCR_DrawCrosshair (float separation)
{
#ifdef QMAX
  float scale;
#endif
...
void V_RenderView( float stereo_separation )
{
	...
	if ( cl.frame.valid && (cl.force_refdef || !cl_paused->value) )
	{
		...
		cl.refdef.width = scr_vrect.width;   //hier vergroessere ich den screen damit man drauf malen kann
		cl.refdef.height = scr_vrect.height;
		cl.refdef.fov_y = CalcFov (cl.refdef.fov_x, scr_vrect.width, cl.refdef.height);
