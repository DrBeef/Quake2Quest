...
#include $(LOCAL_SDL2_PATH)/SDL2-2.0.10/Android.mk
...
#SDL_INCLUDE_PATHS = $(LOCAL_SDL2_PATH)/SDL2-2.0.10/include  $(LOCAL_SDL2_PATH)/SDL2_mixer  $(LOCAL_SDL2_PATH)/SDL2_net  $(LOCAL_SDL2_PATH)/SDL2_image
